...
const alo = map1.set('name','Messi').set('role','Player')
console.log("ALO",alo.toJS())
...
// console.log('PART 1',map1.toJS())
// console.log('PART 1',map2.toJS())
// console.log('PART 1',map3.toJS())
...
// Your code
const khoaArr = [1,2,6,4]
const listFromKhoa = Immutable.List(khoaArr)
const myKhoa1 = listFromKhoa.set(0,'Khoa nef')
const myKhoa2 = listFromKhoa.push('loz')
console.log('PART 3',Array.from(listFromKhoa))
console.log('PART 3',Array.from(myKhoa1))
console.log('PART 3',Array.from(myKhoa2))
// -----------------------------------------------------------------
// -----------------------------------------------------------------
...
const mylistChal = Immutable.List(characters).push({name:'oooo'})
const result = mylistChal.delete(1)
console.log('Challenge',result.toJS())